 ...
 * 
 */
public class CourseDBManagerTestFake {
...
//		System.out.println(dataMgr.showAll());
		...
		assertEquals("\nCourse:CMSC203 CRN:30503 Credits:4 Instructor:Jill B. Who-Dunit Room:SC450",list.get(0));
	 	assertEquals("\nCourse:CMSC204 CRN:30559 Credits:4 Instructor:BillyBob Jones Room:SC450",list.get(1));
//	 	assertEquals("got","expected");

		assertEquals("\nCourse:CMSC203 CRN:30504 Credits:4 Instructor:Joey Bag-O-Donuts Room:SC450",list.get(2));
	}
